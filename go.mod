module github.com/TerraDharitri/drt-go-multi-factor-auth-service
...
require (
	...
	github.com/TerraDharitri/twofactor v0.0.0-20260327052318-a45a2fcdc1a2
...
require (
	...
	github.com/TerraDharitri/drt-go-chain-communication v1.0.1 // indirect
