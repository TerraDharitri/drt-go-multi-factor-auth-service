...
func TestContentLengthLimiter(t *testing.T) {
	...
	t.Run("content too large", func(t *testing.T) {
		...
		registrationPayload := requests.SignMessage{
			...
			UserAddr:     "drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf", // Alice
			GuardianAddr: "drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c",
		}
