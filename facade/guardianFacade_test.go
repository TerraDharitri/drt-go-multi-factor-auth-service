...
func TestGuardianFacade_Getters(t *testing.T) {
	...
	providedUserAddress, _ := data.NewAddressFromBech32String("drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf")
	...
	providedSetSecurityModeRequest := requests.SecurityModeNoExpire{
		Code:       "123456",
		SecondCode: "789101",
		UserAddr:   "drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf",
	}
