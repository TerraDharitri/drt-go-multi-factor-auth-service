...
import (
	...
	sdkTestsCommon "github.com/TerraDharitri/drt-go-sdk/testsCommon"
	...
	"github.com/TerraDharitri/drt-go-multi-factor-auth-service/core/requests"
	...
	"github.com/TerraDharitri/drt-go-multi-factor-auth-service/handlers/storage"
	"github.com/TerraDharitri/drt-go-multi-factor-auth-service/testscommon"
)

const usrAddr = "drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf"
...
var (
	...
	providedUrl       = "otpauth://totp/DharitrI:drt1?algorithm=SHA1&counter=0&digits=6&issuer=DharitrI&period=30&secret=secret"
...
func TestServiceResolver_SignTransaction(t *testing.T) {
	...
	providedSender := "drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf"
	...
	t.Run("tx validation fails, different senders on txs", func(t *testing.T) {
		...
		request := requests.SignMultipleTransactions{
			...
			Txs: []transaction.FrontendTransaction{
				...
				{
					Sender:    "drt14uqxan5rgucsf6537ll4vpwyc96z7us5586xhc5euv8w96rsw95s5rd7km",
					Signature: hex.EncodeToString([]byte("signature")),
				},
			},
		}
...
func TestPutGet(t *testing.T) {
	...
	addr1, _ := sdkData.NewAddressFromBech32String("drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf")
	addr2, _ := sdkData.NewAddressFromBech32String("drt14uqxan5rgucsf6537ll4vpwyc96z7us5586xhc5euv8w96rsw95s5rd7km")
	args := createMockArgs()
