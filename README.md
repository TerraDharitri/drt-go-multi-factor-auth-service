...
[here](https://github.com/TerraDharitri/drt-go-multi-factor-auth-service/blob/main/cmd/multi-factor-auth/config/external.toml).
...
Please check `HTTPHeaders` section in [external.toml](https://github.com/TerraDharitri/drt-go-multi-factor-auth-service/blob/main/cmd/multi-factor-auth/config/external.toml) for more details.
